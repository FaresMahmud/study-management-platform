...
import com.studyplatform.dto.request.FileAnnotationDTO;
import com.studyplatform.dto.response.UploadedFileResponseDTO;
import com.studyplatform.service.UploadedFileService;
...
public class UploadedFileController {
    ...
    @Operation(summary = "Listar todos os arquivos PDF do usuário")
    @GetMapping
    public ResponseEntity<List<UploadedFileResponseDTO>> listAll() {
        return ResponseEntity.ok(uploadedFileService.listAll());
    }
